...
const Stocks = () => {
    ...
    const apiKey = process.env.REAACT_APP_API_KEY;
        ...
        <>
            {
                !flag ? (
                    <div className="container">
                        <div className="row">
                            <div className="col">
                                <div className="card rounded shadow-lg m-2 chart-rule">
                                    <p className="error-message" style={{ padding: "9px" }}>Loadig Data...</p>
                                </div>
                            </div>
                        </div>
                    </div>
